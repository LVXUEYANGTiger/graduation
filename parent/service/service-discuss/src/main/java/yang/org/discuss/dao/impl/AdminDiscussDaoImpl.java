...
/**
 * @author LvXueYang
 * @description 评论系统管理员后台
 */
@Repository
public class AdminDiscussDaoImpl implements AdminDiscussDao {
    @Autowired
    ...
    public int delete(String id) {
        ...
        DeleteResult deleteResult = mongoTemplate.remove(query, Discuss.class, "comment");
    ...
    public List<Discuss> findAll() {
        return mongoTemplate.findAll(Discuss.class);
    }
